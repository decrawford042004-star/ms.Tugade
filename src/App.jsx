...
export default function App() {
  ...
  function handleSubmit(event) {
    ...
    setNotice("Track passed validation. Registry table comes in Phase 2.");
    setForm(emptyForm);
    setErrors({});
  }
  ...
  return (
    <div className="mx-auto min-h-screen max-w-xl px-4 py-10">
      ...
      <form
        ...
        noValidate
        className="space-y-4 rounded-3xl border border-white/70 bg-white/90 p-6 shadow-md"
      >
        ...
        {notice ? (
          <p className="rounded-xl bg-mint px-3 py-2 text-sm text-sage">{notice}</p>
        ) : null}
      </form>
    </div>
  );
